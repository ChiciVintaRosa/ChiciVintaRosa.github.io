        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    Formulir Login  <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'></a>
					
                </div>
                <div class="card-body">
                    <?= form_open('login', ['method' => 'POST']) ?>
                    <center>
                    <img src="<?php echo base_url("images/product/semuatukang.jpg") ?>" style="width:250px" alt="" class="card-img-top">
                </center>
